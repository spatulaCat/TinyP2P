...
public class ConnectInfo extends javax.swing.JFrame {
   ...
   // private boolean err = false;
    ...
    public ConnectInfo(IH2HNode n, String[] i, Rectangle lwl, boolean cr){
        ...
        jButton2.setVisible(NATDetected);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 320, 50, 20));

        jButton2.setBackground(new java.awt.Color(255, 224, 193));
        jButton2.setText("Click here to connect with peers who are on the same local (LAN) network ");
        jButton2.setMargin(new java.awt.Insets(0, 9, 0, 9));
        ...
        jLabel9.setText("You may be behind a NAT router.");
        jLabel9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel9MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 260, 190, -1));
